...
import { CheckCircle2, BarChart3, Database, LineChart } from 'lucide-react';
...
export default function JuniorPlusPage() {
    const weeks = [
        {
            week: 1,
            title: "NumPy Temelleri",
            topics: ["NumPy Array'leri", "Array İşlemleri ve Indexing", "Broadcasting Kavramı", "Matematiksel Fonksiyonlar"],
            icon: Database,
            color: "bg-cyan-100"
        },
        {
            ...
            topics: ["DataFrame ve Series Yapıları", "Veri Okuma ve Yazma", "Veri Filtreleme ve Seçme", "GroupBy ve Aggregation"],
            icon: BarChart3,
            color: "bg-blue-100"
        },
        {
            ...
            topics: ["Line, Bar ve Scatter Plotlar", "Histogram ve Box Plot", "Subplots ve Figure Yönetimi", "Stil ve Özelleştirme"],
            icon: LineChart,
            color: "bg-purple-100"
        },
        {
            week: 4,
            title: "Veri Ön İşleme - 1",
            topics: ["Eksik Veri Yönetimi", "Outlier (Aykırı Değer) Tespiti", "Veri Dönüştürme Teknikleri", "Normalizasyon ve Standardizasyon"],
            icon: Database,
            color: "bg-green-100"
        },
        {
            week: 5,
            title: "Veri Ön İşleme - 2",
            topics: ["Feature Engineering", "Categorical Encoding", "Feature Scaling", "Train-Test Split"],
            icon: BarChart3,
            color: "bg-yellow-100"
        },
        {
            week: 6,
            title: "Proje: Veri Analizi",
            topics: ["Gerçek Veri Seti Analizi", "Exploratory Data Analysis (EDA)", "Veri Görselleştirme Raporu", "Mini Proje: Veri Analizi Uygulaması"],
            icon: LineChart,
            color: "bg-pink-100"
        }
    ];
    ...
    const skills = [
        "NumPy ile hızlı ve etkin array işlemleri yapabilme",
        "Pandas ile büyük veri setlerini manipüle edebilme",
        "Matplotlib ve Seaborn ile profesyonel görselleştirmeler oluşturma",
        "Veri ön işleme tekniklerini uygulayabilme",
        "Exploratory Data Analysis (EDA) yapabilme",
    ...
    return (
        <div className="flex flex-col flex-1 bg-background text-foreground overflow-x-hidden">
            ...
            <main>
                {/* Hero Section */}
                <Section className="min-h-[60vh] pt-32 sm:pt-48 pb-16 bg-gradient-to-b from-[rgba(199,238,255,0.4)] to-transparent">
                    <div className="max-w-7xl mx-auto">
                        <div className="inline-flex items-center gap-3 py-2 pr-6 pl-2 bg-white/70 rounded-full mb-8 text-sm font-light">
                            <span className="w-6 h-6 bg-cyan-500 rounded-full"></span>
                            {' '}
                            EĞİTİM SEVİYESİ
                        </div>
                        ...
                        <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-light leading-normal max-w-3xl mb-8 text-muted-foreground">
                            Python bilgilerinizi pekiştirin ve veri analizi dünyasına giriş yapın. NumPy, Pandas ve Matplotlib ile veri manipülasyonu ve görselleştirme tekniklerini öğrenin.
                        </p>
                        <div className="flex flex-wrap gap-4 mb-12">
                            <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-full">
                                <span className="text-cyan-600 font-semibold">⏱️ 6 Hafta</span>
                            </div>
                            <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-full">
                                <span className="text-cyan-600 font-semibold">📚 Başlangıç-Orta Seviye</span>
                            </div>
                            <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-full">
                                <span className="text-cyan-600 font-semibold">📊 Veri Analizi Odaklı</span>
                            </div>
                        </div>
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Button asChild className="rounded-full uppercase text-base font-medium px-8 py-6 h-auto group bg-cyan-600 hover:bg-cyan-700">
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                            {[
                                ...
                                { name: "Matplotlib", desc: "Veri görselleştirme" },
                                { name: "Seaborn", desc: "Statistical plots" },
                                { name: "Jupyter Notebook", desc: "İnteraktif analiz" },
                                { name: "Scikit-learn", desc: "Veri ön işleme" }
                            ].map((tool) => (
                ...
                <Section>
                    <div className="max-w-7xl mx-auto text-center">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-normal leading-tight tracking-tight mb-6 sm:mb-8 font-headline">
                            Veri analizi becerilerinizi geliştirmeye hazır mısınız?
                        </h2>
