...
import { CheckCircle2, Sparkles, Workflow, Bot } from 'lucide-react';
...
export default function SeniorPage() {
    const weeks = [
        {
            ...
            topics: ["Large Language Models", "GPT, Claude, Gemini API'leri", "Prompt Engineering", "Token Optimization"],
            icon: Sparkles,
            color: "bg-purple-100"
        },
        {
            ...
            topics: ["Vector Databases (Pinecone, Chroma)", "Embedding Models", "Semantic Search", "RAG Pipeline Oluşturma"],
            icon: Bot,
            color: "bg-violet-100"
        },
        {
            ...
            topics: ["Transfer Learning İleri Seviye", "LoRA ve QLoRA", "Fine-tuning LLMs", "Model Evaluation"],
            icon: Sparkles,
        ...
        },
        {
            ...
            topics: ["Agent Architecture", "LangChain & LangGraph", "Agent Orchestration", "Tool Usage & Function Calling"],
            icon: Workflow,
            color: "bg-pink-100"
        },
        {
            ...
            topics: ["n8n Temelleri", "AI Workflow Oluşturma", "API Entegrasyonları", "Otomatik Pipeline'lar"],
            icon: Bot,
            color: "bg-rose-100"
        },
        {
            ...
            topics: ["LLMOps Best Practices", "Monitoring & Observability", "Cost Optimization", "End-to-End AI Agent Projesi"],
            icon: Sparkles,
            color: "bg-red-100"
        }
    ];
    ...
    const skills = [
        "Large Language Model'leri etkin kullanabilme",
        "RAG sistemleri tasarlayıp deploy edebilme",
        "Model fine-tuning ve adaptation teknikleri",
        "Multi-agent sistemler geliştirebilme",
        "LangChain ile kompleks AI uygulamaları oluşturma",
        "n8n ile AI workflow automation yapabilme",
        "Production-ready AI sistemleri deploy edebilme",
        "LLMOps best practices uygulayabilme"
    ];
    ...
    return (
        <div className="flex flex-col flex-1 bg-background text-foreground overflow-x-hidden">
            ...
            <main>
                {/* Hero Section */}
                <Section className="min-h-[60vh] pt-32 sm:pt-48 pb-16 bg-gradient-to-b from-[rgba(243,232,255,0.4)] to-transparent">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-light leading-normal max-w-3xl mb-8 text-muted-foreground">
                            En güncel AI teknolojileriyle tanışın. LLM'ler, RAG, multi-agent sistemler, fine-tuning ve n8n ile production-ready AI uygulamaları geliştirin.
                        </p>
                        <div className="flex flex-wrap gap-4 mb-12">
                            <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-full">
                                <span className="text-purple-600 font-semibold">⏱️ 6 Hafta</span>
                            </div>
                            <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-full">
                                <span className="text-purple-600 font-semibold">📚 Uzman Seviye</span>
                            </div>
                            <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-full">
                                <span className="text-purple-600 font-semibold">🤖 LLM & Agents</span>
                            </div>
                        </div>
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Button asChild className="rounded-full uppercase text-base font-medium px-8 py-6 h-auto group bg-purple-600 hover:bg-purple-700">
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                            {[
                                ...
                                { name: "LangGraph", desc: "Multi-agent systems" },
                                { name: "n8n", desc: "Workflow automation" },
                                { name: "Pinecone", desc: "Vector database" },
                                { name: "ChromaDB", desc: "Embedding storage" },
                                { name: "OpenAI API", desc: "GPT models" },
                                { name: "HuggingFace", desc: "Model hub" },
                                { name: "LangSmith", desc: "Monitoring & debugging" }
                            ].map((tool) => (
                ...
                <Section>
                    <div className="max-w-7xl mx-auto text-center">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-normal leading-tight tracking-tight mb-6 sm:mb-8 font-headline">
                            Yapay zeka alanında uzman olmaya hazır mısınız?
                        </h2>
